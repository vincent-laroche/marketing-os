...
export function provenance(args: PreviewArgs, source: string, rendered: string, extras: Pick<Provenance, "output_sha256" | "campaign_key" | "fixture_sha256" | "compiler_lock_sha256" | "generated_at" | "visibility">): Provenance {
