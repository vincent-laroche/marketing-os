...
7. Publishing requires the OpenAI Sites connector or Codex handoff. If Claude does not have the Sites connector, stop after commit and hand the exact commit hash to Codex for push, save-version, and deploy.
