...
<!-- Generated from ../../.codex/agents/email-deliverability-release-reviewer.md — the Codex definition is the source of truth. Edit it there, then re-run the agent sync. -->
